...
#if !defined(MBEDTLS_SSL_SRV_C) || !defined(MBEDTLS_SSL_PROTO_DTLS) || !defined(MBEDTLS_SSL_COOKIE_C) || !defined(MBEDTLS_NET_C)    \
    || !defined(MBEDTLS_ENTROPY_C) || !defined(MBEDTLS_CTR_DRBG_C) || !defined(MBEDTLS_X509_CRT_PARSE_C) || !defined(MBEDTLS_RSA_C) \
    || !defined(MBEDTLS_CERTS_C) || !defined(MBEDTLS_PEM_PARSE_C) || !defined(MBEDTLS_TIMING_C)
