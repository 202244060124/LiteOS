...
typedef void (*OutputTransformUnitFunc)(const float* src_data, float* dst_data, const float* bias_data, int src_step, int dst_step);
...
void CheckIfUseWinograd(bool* use_winograd, int* output_unit, ConvParameter* conv_param, InputTransformUnitFunc input_trans_func,
