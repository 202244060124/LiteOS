...
parser = argparse.ArgumentParser(
    description="""Create fonts for LittelvGL including the built-in symbols. lv_font_conv needs to be installed. See https://github.com/littlevgl/lv_font_conv
Example: python built_in_font_gen.py --size 16 -o lv_font_roboto_16.c --bpp 4 -r 0x20-0x7F""",
    formatter_class=RawTextHelpFormatter,
)
parser.add_argument(
    "-s", "--size", type=int, metavar="px", nargs="?", help="Size of the font in px"
)
parser.add_argument("--bpp", type=int, metavar="1,2,4", nargs="?", help="Bit per pixel")
parser.add_argument(
    "-r",
    "--range",
    nargs="+",
...
parser.add_argument(
    ...
    metavar="sym",
    default=[""],
    help="Symbols to include. E.g. -s ÁÉŐ".encode("utf-8"),
)
parser.add_argument(
    "--font",
    metavar="file",
...
parser.add_argument(
    "--subpx", action="store_true", help="3 times wider letters for sub pixel rendering"
)
