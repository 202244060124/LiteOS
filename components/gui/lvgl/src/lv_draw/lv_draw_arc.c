...
#define SPLIT_RADIUS_LIMIT \
    10 /*With radius greater then this the arc will drawn in quarters. A quarter is drawn only if there is arc in it */
    ...
    if (q->start_quarter == 0 && q->end_quarter == 0 && q->start_angle < q->end_angle) {
        ...
        if (q->end_quarter == 0) {
            ...
            if (ok)
               ...
               || (q->start_quarter == 2 && q->end_quarter == 1) || (q->start_quarter == 3 && q->end_quarter == 2)
    ...
    if (q->start_quarter == 1 && q->end_quarter == 1 && q->start_angle < q->end_angle) {
        ...
        if (q->end_quarter == 1) {
            ...
            if (ok)
               ...
               || (q->start_quarter == 0 && q->end_quarter == 2) || (q->start_quarter == 0 && q->end_quarter == 3)
    ...
    if (q->start_quarter == 2 && q->end_quarter == 2 && q->start_angle < q->end_angle) {
        ...
        if (q->end_quarter == 2) {
            ...
            if (ok)
               ...
               || (q->start_quarter == 0 && q->end_quarter == 3) || (q->start_quarter == 1 && q->end_quarter == 3)
    ...
    if (q->start_quarter == 3 && q->end_quarter == 3 && q->start_angle < q->end_angle) {
        ...
        if (q->end_quarter == 3) {
            ...
            if (ok)
               ...
               || (q->start_quarter == 2 && q->end_quarter == 0) || (q->start_quarter == 1 && q->end_quarter == 0)
