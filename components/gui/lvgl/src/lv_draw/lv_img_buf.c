 ...
 */
void _lv_img_buf_get_transformed_area(lv_area_t* res, lv_coord_t w, lv_coord_t h, int16_t angle, uint16_t zoom, lv_point_t* pivot)
{
#if LV_USE_IMG_TRANSFORM
...
bool _lv_img_buf_transform_anti_alias(lv_img_transform_dsc_t* dsc)
{
    ...
    if (dsc->tmp.native_color) {
        ...
        _lv_memcpy_small(&c11, &src_u8[dsc->tmp.pxi + dsc->cfg.src_w * dsc->tmp.px_size * yn + dsc->tmp.px_size * xn], sizeof(lv_color_t));
