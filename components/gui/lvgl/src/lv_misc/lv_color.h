                                                                 ...
                                                                 lv_color_t* res_color, lv_opa_t* res_opa)
{
    ...
    /*Both colors have alpha. Expensive calculation need to be applied*/
        ...
        if (fg_opa != fg_opa_save || bg_opa != bg_opa_save || fg_color.full != fg_color_save.full || bg_color.full != bg_color_save.full) {
            fg_opa_save = fg_opa;
            bg_opa_save = bg_opa;
...
#define LV_COLOR_MAKE(r8, g8, b8) \
    ((lv_color_t){{(uint16_t)((b8 >> 3) & 0x1FU), (uint16_t)((g8 >> 2) & 0x3FU), (uint16_t)((r8 >> 3) & 0x1FU)}})
#else
#define LV_COLOR_MAKE(r8, g8, b8) \
    ((lv_color_t){                \
