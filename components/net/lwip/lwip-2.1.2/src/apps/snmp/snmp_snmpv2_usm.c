...
static const struct snmp_oid_range usmUserTable_oid_ranges[] = {{0, 0xff}, {0, 0xff}, {0, 0xff}, {0, 0xff}, {0, 0xff}, {0, 0xff}, {0, 0xff},
...
static snmp_err_t usmusertable_get_instance(const u32_t* column, const u32_t* row_oid, u8_t row_oid_len,
...
static const struct snmp_table_node usmusertable = SNMP_TABLE_CREATE(2, usmusertable_columns, usmusertable_get_instance,
                                                                     usmusertable_get_next_instance, usmusertable_get_value, NULL, NULL);
