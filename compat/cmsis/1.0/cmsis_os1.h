...
#define osThreadDef(name, priority, instances, stacksz) \
    const osThreadDef_t os_thread_def_##name = {#name, (name), (priority), (instances), (stacksz)}
#endif
...
#else                          // define the object
#define osMessageQDef(name, queue_sz, type) const osMessageQDef_t os_messageQ_def_##name = {(queue_sz), sizeof(type), NULL}
#endif
...
#define osMailQDef(name, queue_sz, type)          \
    ...
    const osMailQDef_t os_mailQ_def_##name = {(queue_sz), sizeof(type), &os_mailQ_p_##name}
#endif
